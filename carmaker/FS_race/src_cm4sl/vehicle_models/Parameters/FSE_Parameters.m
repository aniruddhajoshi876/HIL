...
TV_Override = 20;              % increase this parameter to increase the torque vectoring effect; can lead to instability

% ------------------------------
% Recuperation Model
% ------------------------------
eta_Gen = -0.8;                 % efficency of the electric motor in generator mode; always has to negative for the model to work properly
...
% Block Battery
% ------------------------------
SOC_Init =  70;  % Initial SOC [%]
C_Batt   = 9;   % Battery capacity [kWh]
U0_Batt = 400;   % No-load voltage [V]
