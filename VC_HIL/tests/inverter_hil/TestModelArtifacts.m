classdef TestModelArtifacts < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function ephorusRxRetentionRunsFasterThanStatusCycle(testCase)
            ...
            carMakerRetention = [statusPath '/CarMaker Pedal Retention'];
            ...
            testCase.verifyEqual( ...
                ...
                [0.001 0], ...
                'CarMaker Pedal Retention must run at the 1 ms base rate.');
            ...
            testCase.verifyNumElements(carMakerPorts.Outport, 1, ...
                'CarMaker Pedal Retention emits the 3-element pedal demand.');
