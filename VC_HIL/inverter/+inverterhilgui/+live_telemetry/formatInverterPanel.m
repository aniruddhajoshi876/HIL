...
commandTorque = inverterhilgui.live_telemetry.formatTorqueCandidates( ...
    numericOr(item, 'torqueCommandRaw'));
actualTorque = inverterhilgui.live_telemetry.formatTorqueCandidates( ...
...
motor = inverterhilgui.live_telemetry.formatMeasurement( ...
    numericOr(item, 'motorTemperatureC'), ...
    numericOr(item, 'motorTemperatureRaw'), 'C', true);
switchTemperature = inverterhilgui.live_telemetry.formatMeasurement( ...
