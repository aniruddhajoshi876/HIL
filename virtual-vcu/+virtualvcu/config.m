...
c.brakeRestRaw = [9025 9025];
c.brakeRangeLowRaw = [9025 8280];
c.brakePressedRaw = [31800 31800];
c.pedalCanId = uint32(501);
c.stateNames = {'LV_ON','PRECHARGING','ENABLE','BUZZING','RTD','ERROR_SHUTDOWN'};
c.sampleTimeS = 0.005;
c.prechargeTicks = uint32(1500);
c.buzzingTicks = uint32(300);
c.maxTorqueNm = 15;
c.speedLimitRpm = 18000;
c.gearRatio = 13.39;
c.prechargeFloorV = 350;
c.controlsInputCount = 32;
c.controlsTauToInverter = uint8([3 4 2 1]); % INV1..4 <- RL,RR,FR,FL
