...
%VERIFY_VIRTUAL_VCU_MODEL Verify actual Module 3 / Port A block parameters.
if nargin < 1
...
ai = [root '/Module 3 AI01-AI04'];
di = [root '/Module 3 DI01-DI08'];
assert(strcmp(get_param(ai, 'parModuleId'), '3'));
assert(strcmp(get_param(ai, 'parAdChannelLow'), '1'));
assert(strcmp(get_param(ai, 'parAdChannelHigh'), '4'));
assert(strcmp(get_param(di, 'parModuleId'), '3'));
...
fprintf(['R2024b virtual VCU verification passed: Module 3, ' ...
