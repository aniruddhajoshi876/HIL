...
% 9 Ephorus status frames plus 3 synchronized sensor frames (MTi-680G x2,
% Bosch LWS x1; see ADDHARDWAREBOUNDARY's sensorIds), added in 870f596.
assert(sum(strcmp(references, 'speedgoatlib_IO614/CAN Write ')) == 12, ...
    'Expected twelve linked IO614 CAN Write blocks (9 status + 3 sensor).');
