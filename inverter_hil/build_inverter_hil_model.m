...
script = sprintf([ ...
    ...
    'persistent state plantState tickMs\n' ...
    'if isempty(state)\n' ...
    '    state = inverterhil.initialSystemState();\n' ...
    '    plantState = inverterhil.initialPlantState();\n' ...
    '    tickMs = uint32(0);\n' ...
    'end\n' ...
    '[state, plantState, cycle] = inverterhil.stepModel(state, plantState, tickMs);\n' ...
