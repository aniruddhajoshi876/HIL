...
#elif defined(_WIN32) || defined(WIN32) || defined(_XPC)
...
#elif defined(_QNXNTO_PCI_X86_) || defined (VXWORKS) || defined (VXW_PCI_PPC) || defined (VXW_VME_PPC) || defined (VXW_VME_X86) || defined (VXW_PCI_X86) || defined (_SOLARIS_SPARC_) | defined (_SOLARIS_X86_) || defined (_SOLARIS_FORTE_) || defined (__QNX__)
...
#elif defined (INTEGRITY_PCI_PPC) || defined (INTEGRITY_VME_PPC)
