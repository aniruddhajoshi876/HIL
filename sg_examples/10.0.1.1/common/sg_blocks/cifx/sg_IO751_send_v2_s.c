...
#define S_FUNCTION_NAME sg_IO751_send_v2_s
...
static void sg_ModelStep(SimStruct *S)
{
    ...
    /* Transmit Tx data */
    Cifx_SetTxData(Channel, DATA_LEN_ARG, (void *)ssGetInputPortSignal(S, 0));

    if (!Param->OptAcyclic) {

        /* Process Tx data */
        Cifx_ProcessTxData(Channel);
    }
}
