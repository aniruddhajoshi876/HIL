/*
*   File       : sg_IO61X_status_LIN_v2_s.c
*   Description: This file includes all functions of the Simulik S-Function for the IO611 status module for LIN protocol.
*   Version    : $Revison$
*   Author     : $Author$
*   Date       : $Date$
*
...
#define S_FUNCTION_NAME     sg_IO61X_status_LIN_v2_s
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    IO61X_ActivateStatusThread(modIdx, PT_IDX, 0, 0);
