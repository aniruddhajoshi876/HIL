...
#define S_FUNCTION_NAME sg_trdp_md_listen_s
...
#define CONFIRM_ARG       (boolean_T) mxGetPr(ssGetSFcnParam(S, 5))[0]
// 6
...
static void mdlRTW(SimStruct *S)
{
    ...
    if (!ssWriteRTWParamSettings(
        ...
        SSWRITE_VALUE_DTYPE_NUM, "Confirm", &Confirm, DTINFO(SS_BOOLEAN, COMPLEX_NO),
