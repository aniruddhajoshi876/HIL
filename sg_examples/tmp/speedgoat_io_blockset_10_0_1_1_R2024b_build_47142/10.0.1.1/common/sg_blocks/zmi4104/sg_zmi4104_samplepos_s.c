...
#define 	S_FUNCTION_NAME 	sg_zmi4104_samplepos_s
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ptOutPort_SamPos = ssGetOutputPortSignal(S, nPort); 
    
    VmeZmiReadSamplePosition(ptZmiRegs, ptOutPort_SamPos);
