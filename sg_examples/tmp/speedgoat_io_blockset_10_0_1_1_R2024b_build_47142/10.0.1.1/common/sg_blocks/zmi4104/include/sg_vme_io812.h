#ifndef __SG_VME_IO812_H__
#define __SG_VME_IO812_H__
...
//Select debug info
#define IO812_DEBUG_VERBOSE 0     //1=enabled printf; 0=disabled

//show debug info
#if IO812_DEBUG_VERBOSE
#define dbv_printf(fmt, ...) do { printf(fmt, __VA_ARGS__); } while (0)
#else
#define dbv_printf(fmt, ...) {}
#endif

#define DEVNAME         "Speedgoat IO812-VME"
#define VENDORID        0x7357
#define DEVICEID        0x7912
#define SUBVENDORID     XPC_NO_VEND_DEV //Various options: 0x2018, 0x2022
#define SUBDEVICEID     XPC_NO_VEND_DEV //Various options: 0x0101, 0x0205

/* VME Remote memory for 4 AXIS of each ZMI Board */
#define VME_REMOTE_ZMI_BOARD1_AXIS1    0x1000
#define VME_REMOTE_ZMI_BOARD1_AXIS2    0x1400
#define VME_REMOTE_ZMI_BOARD1_AXIS3    0x1800
#define VME_REMOTE_ZMI_BOARD1_AXIS4    0x1c00

#define VME_REMOTE_ZMI_BOARD2_AXIS1    0x5000
#define VME_REMOTE_ZMI_BOARD2_AXIS2    0x5400
#define VME_REMOTE_ZMI_BOARD2_AXIS3    0x5800
#define VME_REMOTE_ZMI_BOARD2_AXIS4    0x5C00

/* VME Node local register - refer to 3.3.21 in ALTHEA manual */ 
#define VME_NODE_LOCAL_STATUS            0x100      // see at IO_bus: 0x400
#define VME_LOCAL_ERROR_STATUS           0x107      // see at IO_bus: 0x41C 
#define VME_LOCAL_ERROR_STATUS2          0x103      // see at IO_bus: 0x40C 
#define VME_LOCAL_ERROR_STATUS3          0x17D      // see at IO_bus: 0x54F

/* Defines Register offset to Board IO810 */
#define ALTHEA_REG_OFFSET               0x1000  
