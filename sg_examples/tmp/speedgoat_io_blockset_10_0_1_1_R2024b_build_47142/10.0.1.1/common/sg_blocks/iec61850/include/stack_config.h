...
#define CONFIG_MAXIMUM_TCP_CLIENT_CONNECTIONS 20
...
/* overwrite default results for MMS identify service */
 #define CONFIG_DEFAULT_MMS_VENDOR_NAME "Speedgoat GmbH"
 #define CONFIG_DEFAULT_MMS_MODEL_NAME "TargetMachine"
/* #define CONFIG_DEFAULT_MMS_REVISION "1.0.0"*/

/* MMS virtual file store base path - where MMS file services are looking for files */
#define CONFIG_VIRTUAL_FILESTORE_BASEPATH "/usr/Speedgoat/" //"./vmd-filestore/"
