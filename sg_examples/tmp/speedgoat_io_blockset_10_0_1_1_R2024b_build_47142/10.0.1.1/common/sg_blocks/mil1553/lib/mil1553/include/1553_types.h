...
#elif defined(__QNX__) || defined (VXWORKS) || defined (VXW_PCI_PPC) || defined (VXW_VME_PPC) || defined (VXW_VME_X86) || defined (VXW_PCI_X86) || defined (_SOLARIS_SPARC_) | defined (_SOLARIS_X86_) || defined (_SOLARIS_FORTE_)
