/*
*   File       : sg_IO613_setup_s.c
*   Description: This file includes all functions of the Simulik S-Function for the IO613 setup module.
*   Version    : $Revison$
*   Author     : $Author$
*   Date       : $Date$
*
...
#define S_FUNCTION_NAME     sg_IO613_setup_s
...
#define QTY_PARAM 24        // Quantity of the S-Function block parameters which are used in this S-Function code file.
...
// CAN port 1
#define CAN_OP_MODE_1 (uint8_T)mxGetPr(ssGetSFcnParam(S, 5))[0]     // Number of the physical bus selection, 1 = highspeed, 0 = lowspeed for port 1.
#define CAN_BDR_BRP_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 6))[0]        // User defined baudrate value BRP for port 1 (CAN)
#define CAN_BDR_SJW_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 6))[1]        // User defined baudrate value SJW for port 1 (CAN)
#define CAN_BDR_TSEG1_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 6))[2]      // User defined baudrate value TSET1 for port 1 (CAN)
#define CAN_BDR_TSEG2_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 6))[3]      // User defined baudrate value TSET2 for port 1 (CAN)
#define CANFD_BDR_DATA_BRP_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 7))[0]     // User defined baudrate value BRP for port 1 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_SJW_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 7))[1]     // User defined baudrate value SJW for port 1 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_TSEG1_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 7))[2]       // User defined baudrate value TSEG1 for port 1 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_TSEG2_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 7))[3]       // User defined baudrate value TSEG2 for port 1 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_SP_1 (real64_T)mxGetPr(ssGetSFcnParam(S, 7))[4]      // User defined baudrate value Sample Point for port 1 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_BDR_1 (uint16_T)mxGetPr(ssGetSFcnParam(S, 7))[5]     // User defined baudrate value baudrate in kBit/s for port 1 (CAN-FD/Data phase).
#define CAN_STD_ACC_MASK_1 (uint32_T)mxGetPr(ssGetSFcnParam(S, 8))[0]       // Standard accetance mask 1 value for port 1 (CAN)
#define CAN_STD_ACC_CODE_1 (uint32_T)mxGetPr(ssGetSFcnParam(S, 8))[1]       // Standard accetance code 1 value for port 1 (CAN)
#define CAN_EXT_ACC_MASK_1 (uint32_T)mxGetPr(ssGetSFcnParam(S, 9))[0]       // Extended accetance mask 1 value for port 1 (CAN)
#define CAN_EXT_ACC_CODE_1 (uint32_T)mxGetPr(ssGetSFcnParam(S, 9))[1]       // Extended accetance code 1 value for port 1 (CAN)

// CAN port 2
#define CAN_OP_MODE_2 (uint8_T)mxGetPr(ssGetSFcnParam(S, 10))[0]        // Number of the physical bus selection, 1 = highspeed, 0 = lowspeed for port 2.
#define CAN_BDR_BRP_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 11))[0]       // User defined baudrate value BRP for port 2 (CAN)
#define CAN_BDR_SJW_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 11))[1]       // User defined baudrate value SJW for port 2 (CAN)
#define CAN_BDR_TSEG1_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 11))[2]     // User defined baudrate value TSET1 for port 2 (CAN)
#define CAN_BDR_TSEG2_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 11))[3]     // User defined baudrate value TSET2 for port 2 (CAN)
#define CANFD_BDR_DATA_BRP_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 12))[0]        // User defined baudrate value BRP for port 2 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_SJW_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 12))[1]        // User defined baudrate value SJW for port 2 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_TSEG1_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 12))[2]      // User defined baudrate value TSEG1 for port 2 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_TSEG2_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 12))[3]      //User defined baudrate value TSEG2 for port 2 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_SP_2 (real64_T)mxGetPr(ssGetSFcnParam(S, 12))[4]     // User defined baudrate value Sample Point for port 2 (CAN-FD/Data phase).
#define CANFD_BDR_DATA_BDR_2 (uint16_T)mxGetPr(ssGetSFcnParam(S, 12))[5]        // User defined baudrate value baudrate in kBit/s for port 2 (CAN-FD/Data phase).
#define CAN_STD_ACC_MASK_2 (uint32_T)mxGetPr(ssGetSFcnParam(S, 13))[0]      // Standard accetance mask 1 value for port 2 (cAN)
#define CAN_STD_ACC_CODE_2 (uint32_T)mxGetPr(ssGetSFcnParam(S, 13))[1]      // Standard accetance code 1 value for port 2 (CAN)
#define CAN_EXT_ACC_MASK_2 (uint32_T)mxGetPr(ssGetSFcnParam(S, 14))[0]      // Extended accetance mask 1 value for port 2 (CAN)
#define CAN_EXT_ACC_CODE_2 (uint32_T)mxGetPr(ssGetSFcnParam(S, 14))[1]      // Extended accetance code 1 value for port 2 (CAN)

// Init/term struct
#define pCAN_INIT_STRUCT ssGetSFcnParam(S, 15)      // Pointer to the initialization structures (CAN)
#define pCAN_TERM_STRUCT ssGetSFcnParam(S, 16)      // Pointer to the termination structures (CAN)

// Hidden
#define pPROTL ssGetSFcnParam(S, 17)        // Name of the protocol.
#define QTY_MOD (uint32_T)mxGetPr(ssGetSFcnParam(S, 18))[0]     // Quantitay of available IO613 SETUP blocks in the Simulink model.
#define pCH_NO ssGetSFcnParam(S, 19)        // Array for the channle number of the port.
#define pPT_TYPES ssGetSFcnParam(S, 20)     // Array for the port types of the module
#define pIS_PROTL_FD ssGetSFcnParam(S, 21)      // Array for the port protocol
#define pPROTL_HELP_IDX ssGetSFcnParam(S, 22)       // Array of the portocol index that's the index of the port within the protocol group (e.g.: CAN 1 = 0, CAN 2 = 1, LIN 1 = 0, LIN 2 = 1)
#define IS_FD_MOD (bool)(mxGetPr(ssGetSFcnParam(S, 23))[0] ? true:false)     // Status flag if current module a CAN-FD module (=true) or not (=false)
...
const int sg_module_type = SG_MODULE_TYPE_IO613;
...
/*
    Set the sample time of the S-Function block.
*/
