...
#define S_FUNCTION_NAME sg_IO754_netstate_v2_s
...
#define ENA_GET_STAT_PT (boolean_T) mxGetPr(ssGetSFcnParam(S, 1))[0]
#define ENA_SET_STAT_PT (boolean_T) mxGetPr(ssGetSFcnParam(S, 2))[0]
