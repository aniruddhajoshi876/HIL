...
#define S_FUNCTION_NAME     sg_IO641_setup_s
...
static void sg_ModelLoad(SimStruct *S)
{
    ...
    snprintf(ModuleName, sizeof(ModuleName), "IO641");
    ...
    snprintf(Node->FwFileName, sizeof(Node->FwFileName), "cifxdpm.nxf");
    snprintf(Node->FwVersionStr, sizeof(Node->FwVersionStr), "2.8.0.1");
    snprintf(Node->BtldName, sizeof(Node->BtldName), "NETX100.bin");
    Node->BlockVersion = 1;
    Node->IsReInit = !sg_isFirstModelLoad();
    snprintf(Node->FwName, sizeof(Node->FwName), "PROFIBUS DP Master");
